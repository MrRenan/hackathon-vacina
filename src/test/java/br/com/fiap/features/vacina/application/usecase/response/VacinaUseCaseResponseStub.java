...
public class VacinaUseCaseResponseStub {

    protected static final Faker faker = new Faker();

    public static VacinaUseCaseResponseStub novo() {
        return new VacinaUseCaseResponseStub();
    }

    public VacinaUseCaseResponse build() {
        return VacinaUseCaseResponse.builder()
